...
const lib = JSON.parse(readFileSync(new URL('./package.json', import.meta.url)));
const outputFileName = 'emcenter';
const name = "emcenter";
const namedInput = './src/index.js'; // 输入
const defaultInput = './src/index.js'; // 默认输入
...
export default async () => {
  ...
  const banner = `// emcenter v${lib.version} Copyright (c) ${year} ${lib.author} and contributors`;
